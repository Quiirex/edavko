...
class edavko
{
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      edavko_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      string    $edavko    The string used to uniquely identify this plugin.
	 */
	protected $edavko;
	 ...
	 *
	 * - edavko_Loader. Orchestrates the hooks of the plugin.
	 * - edavko_i18n. Defines internationalization functionality.
	 * - edavko_Admin. Defines all hooks for the admin area.
	 * - edavko_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the edavko_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    edavko_Loader    Orchestrates the hooks of the plugin.
	 */
